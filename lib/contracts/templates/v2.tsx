      ...
      <View style={styles.content}>
        ...
        <View style={styles.intro}>
          ...
          <View style={styles.partyRow}>
            ...
            <Text style={styles.partyValue}>شركة Jericho Vibes</Text>
          </View>
          <View style={styles.partyRow}>
            <Text style={styles.partyLabel}>الطرف الثاني: </Text>
            <Text style={styles.partyValue}>
              السيد/ة {managerName}، يحمل/ة هوية وطنية رقم ({nationalId})،
              ورقم جوال ({phoneNumber}).
            </Text>
          </View>
        </View>
        ...
        <View style={styles.sigRow} wrap={false}>
          <View style={styles.sigBox}>
            ...
            <Text style={styles.sigName}>Jericho Vibes</Text>
            <Text style={styles.sigDate}>التاريخ: {date}</Text>
          </View>
